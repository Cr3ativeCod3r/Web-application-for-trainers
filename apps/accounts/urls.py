...
urlpatterns = [
    ...
    path('rejestracja/sukces/', views.RegistrationSuccessView.as_view(), name='registration_success'),
    ...
    path('zapomnialem-hasla/', auth_views.PasswordResetView.as_view(
        ...
        email_template_name='emails/accounts/password_reset.txt',
        html_email_template_name='emails/accounts/password_reset.html',
